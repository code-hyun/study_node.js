...
const logDir = `/Users/ailak/Documents/dev_study/06. node_scheduler/logs`;
...
const logger = winston.createLogger({
   ...
   format: combine(
      ...
      label({ label: 'Logger Test' }), // 어플리케이션 이름
      logFormat, // log 출력 포맷
   ...
   transports: [
      ...
      new winstonDaily({
         ...
         dirname: logDir + '/log', // 파일 경로
         filename: `air_quailty_%DATE%.log`, // 파일 이름
      ...
      new winstonDaily({
         ...
         filename: `air_quailty_%DATE%_error.log`, // 에러 로그는 2020-05-28.error.log 형식으로 저장
         maxFiles: 30,
         zippedArchive: true,
      }),
   ],
   ...
   exceptionHandlers: [
      new winstonDaily({
         ...
         datePattern: 'YYYY-MM-DD',
         dirname: logDir,
         filename: `air_quailty_exception_%DATE%.log`,
         maxFiles: 30,
         zippedArchive: true,
      }),
   ],
