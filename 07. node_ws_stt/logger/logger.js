...
const logDir = `/Users/ailak/Documents/dev_study/07. node_ws_stt/log`;
...
const logger = winston.createLogger({
   ...
   format: combine(
      ...
      label({ label: 'NODE_WS_STT' }), // 어플리케이션 이름
      logFormat, // log 출력 포맷
   ...
   transports: [
      ...
      new winstonDaily({
         ...
         filename: `NODE_WS_STT_%DATE%.log`, // 파일 이름
      ...
      new winstonDaily({
         ...
         dirname: logDir + '/log', 
         filename: `NODE_WS_STT_%DATE%_error.log`, // 에러 로그는 2020-05-28.error.log 형식으로 저장
         maxFiles: 30,
         zippedArchive: true,
      }),
   ],
   ...
   exceptionHandlers: [
      new winstonDaily({
         ...
         datePattern: 'YYYY-MM-DD',
         dirname: logDir + '/log',
         filename: `NODE_WS_STT_exception_%DATE%.log`,
         maxFiles: 30,
         zippedArchive: true,
      }),
   ],
